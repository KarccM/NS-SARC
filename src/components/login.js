        ...
        <>
            ...
            <div className="h-screen flex">
                        <div className="m-auto mx-32 flex rounded-md bg-gray-100">
                            <img src={photo} className=" w-1/2 rounded-md object-cover object-center" />
                                ...
                                <form className="" onSubmit={handleSubmit}>
                                    <div>
                                        {login.map((field) => {
                                            return (
                                                <Field
                                                    style="mx-4 mt-4 w-2/3 rounded-full bg-white px-2 lg:px-4 lg:py-2 lg:my-4"
                                                    field={field}
                                                    Context={loginContext} />
                                            );
                                        })}
                                    </div>
                                    <button className={cosBTN} type="submit">Login</button>
                                <a className="text-red-600 hover:text-red-400
                                                text-sm text-right
                                                font-semibold mr-2
                                ...
                                >Forget Password?</a>
                                    <p className=" mb-4 mt-4 border-t-2 border-gray-200 pt-2">
                                        Don't have an account? <a
                                            className="text-red-600 hover:text-red-400 text-sm lg:text-lg text-right font-semibold mr-2 cursor-pointer">Register Here</a></p>
                                </form>
                            </div>
                        </div>
                </div>
